...
@Component({
  selector: 'app-grafica-solvencia',
  templateUrl: './grafica-solvencia.component.html',
  styleUrls: ['./grafica-solvencia.component.scss']
})
export class GraficaSolvenciaComponent {
  public chart: Chart;
